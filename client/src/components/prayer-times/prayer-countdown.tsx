...
import { PrayerTimeCalculator } from "./prayer-time-calculation";
...
export function PrayerCountdown({ prayerConfig }: PrayerCountdownProps) {
  ...
  useEffect(() => {
    ...
    // Use default values for Tottori if not provided in prayerConfig
    ...
    const { calculationMethod, asrJuristic } = prayerConfig;
    ...
    const calculateNextPrayerTime = () => {
      ...
      const prayerTimes = calculatePrayerTimes({
        date, month, year, latitude, longitude, timezone, 
        calculationMethod, asrJuristic
      });
